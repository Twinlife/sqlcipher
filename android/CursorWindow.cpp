...
row_slot_t * CursorWindow::getRowSlot(uint32_t row)
{
...
field_slot_t * CursorWindow::getFieldSlotWithCheck(uint32_t row, uint32_t column)
{
...
uint32_t CursorWindow::read_field_slot(uint32_t row, uint32_t column, field_slot_t * slotOut)
{
